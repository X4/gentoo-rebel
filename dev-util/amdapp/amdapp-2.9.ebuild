...
SRC_URI="http://developer.amd.com/tools-and-sdks/heterogeneous-computing/amd-accelerated-parallel-processing-app-sdk/downloads/AMD-APP-SDK-v2.9-lnx64.tgz"
#		amd64? ( ${AMD64_AT} )
#		x86? ( ${X86_AT} )"
LICENSE="AMD"
SLOT="0"
